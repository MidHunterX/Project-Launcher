...
* No Lockfile awareness beyond basic checks; no automatic npm install decision upon dependency update.
* Always assumes you have stable internet connection to download dependencies.
