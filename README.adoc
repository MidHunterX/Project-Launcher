...
config parameters. Root directory name is set as PROJECT_NAME. PROJECT_TYPE is
set based on the files or imports in the project. After detecting the type, the
default url and port of framework is set as URL. xdg-open is set as BROWSER.
