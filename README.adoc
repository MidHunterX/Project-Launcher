...
Structure::
Following documented official dir structure: link:https://go.dev/doc/modules/layout[layout]

'''
image::./.assets/icons/save_game.png["Floppy Disk",46,align="center",link="https://www.bored.com/"]
[.text-center]
