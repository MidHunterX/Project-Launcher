image:./.assets/project_launcher_banner.jpg["Banner for Project Launcher. The background features a GTA San Andreas meme with CJ walking through an alleyway. The subtitle shows a modified line from the video game meme 'Another project? Ah shit, here we go again.' Which accurately represents the use of this tool. Rocket Launcher icon from GTA is showcased as the logo, signifying the force which a project can be launched with this tool. Besides the logo, there is a text 'Project Launcher' in GTA San Andreas aesthetic."]
...
== image:./.assets/icons/property_available.gif["Green House",32] Installation
...
== image:./.assets/icons/race.gif["Checkered Flag",32] Quick Start
...
== image:./.assets/icons/mod_garage.gif["Wrench",32] Configuration Settings
...
=== image:./.assets/icons/player_position.gif["Navigator",20] Per-Project Configuration
...
=== image:./.assets/icons/north.gif["North",20] Global Configuration
...
== image:./.assets/icons/tattoo.gif["Tattoo",32] Customization
...
== image:./.assets/icons/property_unavailable.gif["Red House",32] Known Issues & Limitations
...
== image:./.assets/icons/unknown.gif["Question Mark",32] Q&A
...
== image:./.assets/icons/emmet.gif["Gun",32] License
